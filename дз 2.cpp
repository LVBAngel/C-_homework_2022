//В этом примере, BankCell хранит список всех владельцев, а Human хранит список всех своих ячеек.Когда Human умирает, деструктор вызывается, проверяет активность каждой ячейки и, если ячейка не активна(то есть все владельцы умерли), сообщает о её закрытии.
